...
const DisplayReview = ({ reviews, setReviews, setEditableComment, setEdit, setEditingReviewId}) => {
                            ...
                            >
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <h2 className="font-semibold text-[#242253]">{review.reviewerName}</h2>
                                        <div>
                                            <StarRatings
                                    ...
                                    <div className="flex gap-3">
                                        {
                                            user?.email === review.reviewerEmail ? <>
                                                <button
                                                    ...
                                                    onClick={() =>handleEditableComment(review.comment, review._id)}
                                                >
                                                    Edit
                                                </button>
                                                <button
                                ...
                                <p className="text-gray-600 text-base leading-[30px]">{review.comment}</p>
                            </div>
                        ))}
                    </>
                )
