  ...
  const slides = [
    {
      ...
      subtitle:
        "Easily organize, track, and manage all your favorite books in one place — from classics to current reads.",
    },
    {
      img: "https://i.ibb.co/4Rp8Prrd/hero-1.jpg",
      title: "Read More, Worry Less",
      subtitle:
        "Log your reading history, set goals, and never forget where you left off — perfect for every book lover.",
    },
    {
      img: "https://i.ibb.co/rGVBDypZ/CTA.jpg",
      title: "Discover. Track. Reflect.",
      subtitle:
        "Keep notes, rate your books, and revisit your reading journey anytime with a beautifully designed interface.",
    },
  ];
            ...
            <div className="relative h-full w-full overflow-hidden">
              <img
                ...
                className={`w-full h-full object-cover transition-transform duration-1000 ease-in-out ${
                  activeIndex === index ? "scale-100" : "scale-200"
                }`}
              />
              <div
              ...
              >
                <div className="flex flex-col justify-center items-center">
                  <h1 className="text-3xl md:text-4xl font-bold text-center text-white px-5 md:px-0">
                    {slide.title}
                  </h1>
                  <p className="text-lg medium w-[70%] text-center pt-5 text-white">
                    {slide.subtitle}
                  </p>
                </div>
              </div>
